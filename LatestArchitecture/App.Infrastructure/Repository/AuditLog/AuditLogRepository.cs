...
{
    public class AuditLogRepository : DbConnectionRepositoryBase, IAuditLogRepository
    {
        public AuditLogRepository(MasterDbContext context, IDbConnectionFactory dbConnectionFactory)
        ...
        //private readonly ConcurrentDictionary<string, GetForeignKeyTableData> _entityValueCache = new ConcurrentDictionary<string, GetForeignKeyTableData>();

        //public (int ColumnId, string MasterEntity) GetColumnInfo(int tableId, string columnName)
        //{
        //    string key = $"{tableId}_{columnName}";
        //    if (_columnCache.TryGetValue(key, out AuditLogMasterColumn column))
        //    {
        //        return (column.ID, column.MasterEntityName);
        //    }
        //    return (0, null);
        //}
        ...
        //{
        //    // Use direct access to entity class based on entity name
        //    switch (masterEntityName)
        //    {
        //        case AuditLogMasterEntity.User:
        //            return GetUserValue(masterEntitesId, portalId);
        //        case AuditLogMasterEntity.MasterCountry:
        //            return GetCountryValue(masterEntitesId);
        //        case AuditLogMasterEntity.MasterState:
        //            return GetStateValue(masterEntitesId);
        //        case AuditLogMasterEntity.Organization:
        //            return GetOrganizationValue(masterEntitesId);
        //        default:
        //            return null;
        ...
        //{
        //    // Use compiled query or direct join for better performance
        //    if (portalId == (int)MasterPortals.SuperAdminPortal)
        //    {
        //        return _dbContext.Users
        //                  .Where(x => x.Id == masterTableId)
        //                  .Select(x => new GetForeignKeyTableData
        //                  {
        ...
        //    //              .Where(x => x.UserID == masterTableId)
        //    //              .Select(x => new GetForeignKeyTableData
        //    //              {
        //    //                  Value = x.FirstName + " " + x.LastName
        //    //              })
    ...
    */
        ...
        ///for reference
        //private GetForeignKeyTableData GetMasterICDValue(int masterTableId)
        //{
        //    return _dbContext.MasterICD
        //        .Where(x => x.Id == masterTableId)
        //        .Select(x => new GetForeignKeyTableData
        //        {
        //            Value = x.Code
